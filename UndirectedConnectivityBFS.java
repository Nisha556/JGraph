...
public void bdf(int adjacency_matrix[][], int source)
{
	int number_of_nodes = adjacency_matrix[source].length-1;
	int[] visited = new int[number_of_nodes +1];int i, element;
	visited[source] =1;
    queue.add(source);
	while(!queue.isEmpty())
	{
	...
	if(connected)
	{
		...
		System.out.println("This graph is disconnected");
...
public static void main(String agsr[])
{
	...
	try {
		System.out.println("Enter the number of the graph");
